...
def levelthreemenu(win):
    ...
    levelthreemenu.setFill('green')

    menu3message = Text(Point(500,500), 'In level three there will be green friendlies trying to help you.')
    menu3message.setSize(24)
    menu3message.setStyle("bold")
    menu3message.setTextColor('black')
        
    menu3message2 = Text(Point(500,400), 'Do not click on the friendlies or you will lose 1 point!')
    menu3message2.setSize(24)
    menu3message2.setStyle("bold")
    menu3message2.setTextColor('red')

    menu3message3 = Text(Point(500,300), 'Try to finish the level with more than 10 points!')
    menu3message3.setSize(24)
    menu3message3.setStyle("bold")
    menu3message3.setTextColor('black')
    
    menu3message4 = Text(Point(500,150), "Level three will begin in 10 seconds...")
    menu3message4.setSize(30)
    menu3message4.setStyle("bold")
    menu3message4.setTextColor('black')

    levelthreemenu.draw(win)
    menu3message.draw(win)
    menu3message2.draw(win)
    menu3message3.draw(win)
    menu3message4.draw(win)

    time.sleep(10)

    levelthreemenu.undraw()
    menu3message.undraw()
    menu3message2.undraw()
    menu3message3.undraw()
    menu3message4.undraw()

def levelthreewinmenu(pointvalue):

    lvlthreewinback = Rectangle(Point(0,0),Point(1000,1000))
    lvlthreewinback.setFill('white')
    lvlthreewinback.draw(win)

    win3message = Text(Point(500,500), "Congratulations!")
    win3message.setSize(36)
    win3message.setStyle("bold")
    win3message.setTextColor('yellow')

    win3message2 = Text(Point(500,400), "You Pass Level Three!")
    win3message2.setSize(36)
    win3message2.setStyle("bold")
    win3message2.setTextColor('yellow')

    final3score = "Your score was " +str(pointvalue)

    win3message3 = Text(Point(500,300), final3score)
    win3message3.setSize(36)
    win3message3.setStyle("bold")
    win3message3.setTextColor('red')

    passmessage3 = Text(Point(500,200), "Wait 5 seconds for the final menu!")
    passmessage3.setSize(36)
    passmessage3.setStyle("bold")
    passmessage3.setTextColor('green')


    
    win3message.draw(win)
    win3message2.draw(win)
    win3message3.draw(win)
    passmessage3.draw(win)
    ...
    win3message3.undraw()
    passmessage3.undraw()
    lvlthreewinback.undraw()

def thanks(win):
    thanksmenu = Rectangle(Point (0,0), Point(1000,1000))
    thanksmenu.setFill('white')
    thanksmenu.draw(win)

    thanks = Text(Point(500,450), "Thank you for playing this game!")
    thanks.setSize(36)
    thanks.setStyle("bold")
    thanks.setTextColor("sea green")
    thanks.draw(win)

    thanks2 = Text(Point(500,350), "We hope you enjoyed!")
    thanks2.setSize(36)
    thanks2.setStyle("bold")
    thanks2.setTextColor("sea green")
    thanks2.draw(win)
...
def levelthree():
    ...
    # Generate a random number of friendlies within the specified range
